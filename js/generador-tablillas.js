(function (window, document) {
      ...
      '<div class="ams-scene" data-spotify-track="' + attr(trackId) + '" style="position:relative;box-sizing:border-box;width:100%;max-width:650px;margin:28px auto;padding:10px 11px 11px 10px;">' +
        ...
        '<div class="ams-sheet" style="position:relative;z-index:2;box-sizing:border-box;padding:16px;background:var(--bg-panel);border:1px solid var(--line);box-shadow:var(--shadow-soft);overflow:hidden;">' +
          ...
          '<div class="ams-calendar" style="display:grid;grid-template-columns:90px minmax(0,1fr);align-items:stretch;gap:15px;">' +
            '<div class="ams-date" style="display:flex;min-height:108px;flex-direction:column;align-items:center;justify-content:center;background:var(--accent-sage);border:1px solid color-mix(in srgb,var(--accent-sage) 72%,var(--line));">' +
              '<b class="ams-date-number" style="color:#fff!important;font-family:var(--font-title);font-size:38px;font-weight:400;line-height:.95;">' + text(d.day) + '</b>' +
              '<span class="ams-date-month" style="margin-top:8px;color:#fff!important;font-size:9px;font-weight:800;line-height:1;letter-spacing:.22em;text-transform:uppercase;">' + text(d.month) + '</span>' +
            '</div>' +
          ...
          '<div class="ams-soundtrack">' +
            '<div class="ams-label" style="display:flex;align-items:center;gap:10px;margin:0 3px 10px;">' +
              '<span aria-hidden="true" style="display:flex;flex:0 0 38px;align-items:center;justify-content:center;width:38px;height:38px;color:#fff!important;background:var(--accent-sage);border:1px solid var(--accent-sage);border-radius:999px;font-family:serif;font-size:24px;line-height:1;">♪</span>' +
  ...
  function buildSpotify(d) {
    ...
    return '<div class="asp-spotify" data-spotify-track="' + attr(trackId) + '" style="position:relative;box-sizing:border-box;width:100%;max-width:650px;margin:28px auto;padding:9px 10px 10px 9px;"><div class="asp-spotify-back" aria-hidden="true" style="position:absolute;inset:8px 1px 1px 8px;background:color-mix(in srgb,var(--accent-sage) 10%,var(--bg-soft));border:1px solid var(--line-soft);box-shadow:var(--shadow-soft);transform:rotate(-1.2deg);"></div><div class="asp-spotify-sheet" style="position:relative;z-index:2;display:flex;align-items:stretch;gap:14px;box-sizing:border-box;padding:14px;background:var(--bg-panel);border:1px solid var(--line);box-shadow:var(--shadow-soft);overflow:hidden;"><div class="asp-spotify-tape" aria-hidden="true" style="position:absolute;left:30px;top:-8px;width:78px;height:20px;background:color-mix(in srgb,var(--accent-rose) 10%,var(--bg-soft));border:1px solid var(--line-soft);opacity:.9;transform:rotate(-4deg);"></div><div class="asp-spotify-label" style="position:relative;display:flex;flex:0 0 94px;min-height:164px;box-sizing:border-box;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:17px 10px 13px;background:var(--bg-soft);border:1px solid var(--line);box-shadow:inset 0 3px 0 var(--accent-sage);text-align:center;"><div class="asp-spotify-kicker" style="color:var(--accent-rose)!important;font-family:var(--font-base);font-size:7px;font-weight:800;line-height:1;letter-spacing:.18em;text-transform:uppercase;">now playing</div><div class="asp-spotify-note-frame" style="display:flex;align-items:center;justify-content:center;width:44px;height:44px;background:var(--bg-panel);border:1px solid var(--line-soft);border-radius:999px;box-shadow:inset 0 0 0 5px var(--bg-soft);"><div class="asp-spotify-note" aria-hidden="true" style="color:var(--accent-sage)!important;font-family:serif;font-size:27px;font-weight:400;line-height:1;">♪</div></div><div aria-hidden="true" style="width:34px;height:1px;background:var(--line);"></div><div class="asp-spotify-label-text" style="color:var(--title-color)!important;font-family:var(--font-title);font-size:8px;font-weight:600;line-height:1.35;letter-spacing:.16em;text-transform:uppercase;overflow-wrap:anywhere;">' + text(d.label || 'soundtrack') + '</div></div><div class="asp-spotify-player" style="display:flex;flex:1;min-width:0;align-items:center;box-sizing:border-box;padding:6px;background:var(--bg-main);border:1px solid var(--line-soft);"><iframe title="Reproductor de Spotify" src="https://open.spotify.com/embed/track/' + attr(trackId) + '?theme=0" width="100%" height="152" frameborder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy" style="display:block;width:100%;height:152px;border:0;border-radius:12px;"></iframe></div></div></div>';
  }
